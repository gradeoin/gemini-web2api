...
def main():
    ...
    try:
        try:
            threading.Thread(target=lambda: (time.sleep(0.8), webbrowser.open("https://radon-8mm.pages.dev?localProxyUrl=http://127.0.0.1:8081/v1/chat/completions&enableProxy=true")), daemon=True).start()
        except Exception:
            pass
